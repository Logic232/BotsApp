const data = {
  general: {
    ...
    SUDO_PERMISSION:
        "```Hey there, I am 💠Arcee💠. I guess you were trying to use my commands in```. However, the bot is currently in {worktype} mode. This enables only the owner and sudo users to use the command``` *{commandName}* ```.\n\nIf you are keen to use my features, you can deploy Arcee on your own account without much effort, in less than 5 minutes! Check out the links given below.```\n\n🔗https://myArcee.com\n🔗https://github.com/ArceeOfficial/Arcee",
    ERROR_TEMPLATE:
